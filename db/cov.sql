...
INSERT INTO `patients` VALUES (1,'marvin garvis',' 93A rediie street, chicago','98','+473456786','',NULL),(2,'selena wesl',' 34A arthure street, miami','79','+78675456','',NULL),(3,'pasan','colocmbo','45','+94765567980',NULL,'maharagama');
...
INSERT INTO `quarantine_centres` VALUES (2,79.90230000,54.09000000,'maharagama');
...
CREATE TABLE `sms_status` (
  ...
  `is_reset` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `sms_status` VALUES (1,'true',3,'0766654560',NULL),(2,'true',3,'07666545687',NULL),(3,'true',3,'0766654560',NULL),(4,'true',3,'07666545687',NULL);
...
-- Dump completed on 2021-08-08 20:04:26
